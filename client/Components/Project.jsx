  ...
  return (
    <>
      ...
      <div className="singleProject__wrapper">
        ...
        <em>
          <h2 className="singleProject__subtitle">{project?.subtitle}</h2>
        </em>
      ...
      <div className="singleProject__technologies">
        {project?.technologies.map((technology, iterator) => {
          return (
            <div className="singleProject__tag" key={iterator}>
              {technology}
            </div>
          )
        })}
      ...
      <div className="singleProject__wrapper">
        ...
        {project.video ? (
          <ProjectWithVideo project={project} />
        ) : (
          <ProjectNoVideo project={project} />
        )}
      </div>
    </>
  )
